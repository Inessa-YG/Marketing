# Project Title — customer insights in FMCG
...
- Objective: measurable goal (e.g., "increase cross-sell conversion by 5%")


## 2. TL;DR — Key findings & impact
...
## 3. Skills & Tools
- Python (pandas, scikit-learn), SQL (Postgres), PowerBI, Git, Docker (if used)


## 4. Repo structure
Explain folders briefly (see project root)
